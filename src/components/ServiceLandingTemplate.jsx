    ...
    <div className="w-full max-w-full overflow-x-hidden bg-white font-['Poppins'] text-[#071124]">
      <section className="relative mt-[96px] min-h-[calc(100svh-96px)] overflow-hidden bg-[#06111f] sm:mt-[104px] sm:min-h-[calc(100vh-104px)]">
        <picture>
          {page.backgrounds.heroMobile && (
            <source
              ...
              srcSet={page.backgrounds.heroMobile}
            />
          )}
          <img
            decoding="async"
            loading="lazy"
            src={page.backgrounds.hero}
            alt="Vibha Art Services - Graphic Design and Printing"
        ...
        <div className="container relative z-10 mx-auto flex min-h-[calc(100svh-96px)] max-w-full items-center px-4 py-10 sm:min-h-[calc(100vh-104px)] sm:px-6 sm:py-20">
          ...
          >
            <p
              className="mb-4 max-w-full text-[11px] font-extrabold uppercase tracking-[0.22em] sm:mb-5 sm:text-[12px] sm:tracking-[0.32em]"
              style={{ color: accent }}
            >
              {page.hero.eyebrow}
            </p>
            ...
            <div
              className={`mt-8 max-w-lg grid-cols-2 gap-4 sm:grid sm:grid-cols-4 ${page.hero.hideStatsOnMobile ? "hidden" : "grid"}`}
            >
              {page.hero.stats.map((item) => (
                <div key={`${item.title}-${item.label}`} className="group">
                  <div
                    className="mb-3 flex h-14 w-14 items-center justify-center rounded-lg border border-white/10 bg-white/8 shadow-[0_18px_40px_rgba(0,0,0,0.22)] backdrop-blur"
                    style={{ color: accent }}
                  >
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${page.backgrounds.services})`,
      ...
      >
        <div className="container relative z-10 mx-auto max-w-full px-4 sm:px-6">
          <div className="mx-auto mb-8 max-w-3xl text-center sm:mb-12">
            ...
            <h2
              className="mt-4 !text-[clamp(1.8rem,9vw,2.5rem)] font-extrabold !leading-tight text-[#071124] sm:!text-5xl"
              style={textFill}
            >
              {page.servicesSection.title}{" "}
              <span style={{ color: accent }}>
                {page.servicesSection.highlight}
              </span>
            </h2>
          ...
          <div
            className={
              ...
              cardVariant === "premiumIcon"
                ? "grid min-w-0 gap-5 sm:gap-7 md:grid-cols-2 xl:grid-cols-4"
                : "grid min-w-0 gap-5 sm:gap-7 md:grid-cols-2 xl:grid-cols-3"
            }
          >
            {page.services.map((service, index) => (
              ...
              >
                <span
                  className={`absolute inset-x-0 top-0 h-1 ${cardVariant === "premiumIcon" ? "opacity-100" : "opacity-0 transition group-hover:opacity-100"}`}
                  style={{
                    background: `linear-gradient(90deg, ${accent}, #ff7a59, #6f63ff)`,
                  }}
                />
                <span
                  className="pointer-events-none absolute -right-16 -top-16 h-36 w-36 rounded-full blur-3xl transition"
                ...
                {cardVariant === "image" ? (
                  <>
                    <span className="relative block h-40 overflow-hidden bg-[#eef1f5] sm:h-44">
                      ...
                      />
                      <span
                        className="absolute right-4 top-4 flex h-10 w-10 items-center justify-center rounded-full text-white shadow-[0_12px_28px_rgba(255,63,81,0.32)]"
                        style={{ backgroundColor: accent }}
                      >
                        <IconSlot
                          item={service}
                    ...
                    <span className="relative z-10 block p-5 sm:p-6">
                      <span className="text-lg font-extrabold leading-tight text-[#071124]">
                        {service.title}
                      </span>
                      <span className="mt-3 block text-sm font-medium leading-7 text-[#667085]">
                        {service.description}
                      </span>
                      <span
                  ...
                  <span className="relative z-10 flex h-full min-w-0 flex-col">
                    ...
                    <span
                      className={
                        cardVariant === "premiumIcon"
                          ? "relative text-lg font-extrabold leading-tight text-[#071124]"
                          : "text-lg font-extrabold leading-tight text-[#071124]"
                      }
                    >
                      {service.title}
                    </span>
                    <span
                      className={
                        cardVariant === "premiumIcon"
                          ? "relative mt-4 flex-1 text-sm font-medium leading-7 text-[#667085]"
                          : "mt-4 flex-1 text-sm font-medium leading-7 text-[#667085]"
                      }
                    >
                      {service.description}
                    </span>
                    <span
                      className="relative mt-6 inline-flex items-center gap-2 text-sm font-extrabold"
                      style={{ color: accent }}
                    >
                      Explore More <ArrowRight size={15} />
                    </span>
                  ...
                  <>
                    <span className="relative z-10 flex min-h-0 min-w-0 flex-1 flex-col">
                      <span className="mb-5 flex items-center justify-between gap-4">
                        <span
                          className="flex h-14 w-14 items-center justify-center rounded-2xl border border-[#eceeff] bg-[linear-gradient(145deg,#ffffff,#f2f4ff)] text-[#5d56ff] shadow-[0_16px_35px_rgba(82,91,255,0.16)] transition group-hover:border-[#ffd6dc]"
                          style={{ color: service.iconColor || "#5d56ff" }}
                        >
                          <IconSlot
                            item={service}
                            size={24}
                      ...
                      <span className="text-lg font-extrabold leading-tight text-[#071124] sm:text-xl">
                        {service.title}
                      </span>
                      <span className="mt-3 text-sm font-medium leading-7 text-[#667085]">
                        {service.description}
                      </span>
                    ...
                    <span className="relative z-10 mt-5 flex h-[132px] min-w-0 items-center justify-center overflow-hidden rounded-lg border border-[#edf0f6] bg-[linear-gradient(145deg,#f8fafc,#ffffff)] shadow-inner sm:mt-0 sm:h-full">
                      ...
                      />
                      <span
                        className="absolute bottom-3 left-3 h-2 w-14 rounded-full opacity-80 shadow-[0_0_22px_rgba(255,63,81,0.55)]"
                        style={{ backgroundColor: accent }}
                      />
      ...
      <section className="relative overflow-hidden bg-[#06111f] py-12 text-white sm:py-24">
        <img
          decoding="async"
          loading="lazy"
        ...
        <div className="container relative z-10 mx-auto max-w-full px-4 sm:px-6">
          <div className="mx-auto mb-9 max-w-3xl text-center sm:mb-14">
            ...
            <h2
              className="mt-4 !text-[clamp(1.8rem,9vw,2.5rem)] font-extrabold !leading-tight text-white sm:!text-5xl"
              style={textFill}
            >
              {page.processSection.title}{" "}
              <span style={{ color: accent }}>
                {page.processSection.highlight}
              </span>{" "}
              {page.processSection.suffix}
            </h2>
          ...
          <div
            className={`relative grid min-w-0 gap-5 sm:gap-6 md:grid-cols-2 ${processColumnClass}`}
          >
            ...
            {page.processSteps.map((step, index) => (
              ...
              >
                <span
                  className="pointer-events-none absolute -right-12 -top-12 h-32 w-32 rounded-full blur-3xl transition"
                  style={{ backgroundColor: `${accent}24` }}
                />
                <span
                  className="pointer-events-none absolute inset-x-0 top-0 h-1 opacity-75"
                  style={{
                    background: `linear-gradient(90deg, ${accent}, #ff7a59, #6f63ff)`,
                  }}
                />
                <div className="relative z-10 mb-7 flex items-center justify-between">
                  <div
                    className="relative flex h-16 w-16 items-center justify-center rounded-2xl border border-white/15 bg-[#071124]/55 shadow-[0_18px_45px_rgba(255,63,81,0.14)] transition group-hover:scale-105 group-hover:text-white sm:h-20 sm:w-20"
                    style={{ color: accent }}
                  >
                    <IconSlot item={step} size={32} imageClassName="p-4" />
                  </div>
                  <span
                    className="flex h-11 w-11 items-center justify-center rounded-full border text-xs font-extrabold text-white shadow-[0_12px_34px_rgba(255,63,81,0.24)]"
                    style={{
                ...
                <div className="relative z-10">
                  ...
                  <p className="mt-3 text-sm font-medium leading-7 text-white/72 sm:min-h-[84px]">
                    {step.text}
                  </p>
                  <div className="mt-5 h-1.5 overflow-hidden rounded-full bg-white/10">
                    <span
                      ...
                      style={{
                        width: `${((index + 1) / page.processSteps.length) * 100}%`,
      ...
      <section
        className="relative overflow-hidden py-12 sm:py-24"
        style={{
          backgroundImage: `url(${page.backgrounds.whyChoose})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        <div className="container relative z-10 mx-auto grid max-w-full items-center gap-8 px-4 sm:gap-12 sm:px-6 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="relative min-w-0">
            <p
              className="mb-4 text-[11px] font-extrabold uppercase tracking-[0.2em] sm:text-[12px] sm:tracking-[0.28em]"
              style={{ color: accent }}
            >
              {page.whyChoose.eyebrow}
            </p>
            <h2
              className="!text-[clamp(1.8rem,9vw,2.5rem)] font-extrabold !leading-tight text-[#071124] sm:!text-5xl"
              style={textFill}
            >
              {page.whyChoose.title}{" "}
              <span style={{ color: accent }}>{page.whyChoose.highlight}</span>
            </h2>
            ...
            <div className="mt-7 grid max-w-xl grid-cols-2 overflow-hidden rounded-lg border border-white/80 bg-white/75 shadow-[0_18px_55px_rgba(7,17,36,0.1)] backdrop-blur sm:mt-9 sm:grid-cols-4 sm:shadow-[0_24px_80px_rgba(7,17,36,0.1)]">
              {page.whyChoose.stats.map(([value, label]) => (
                <div
                  key={label}
                  className="min-w-0 border-r border-b border-[#edf0f6] px-2 py-4 text-center even:border-r-0 last:border-r-0 sm:border-b-0 sm:even:border-r sm:last:border-r-0 sm:px-4 sm:py-5"
                >
                  <AnimatedNumber
                    value={value}
                    as="p"
                  ...
                  />
                  <p className="mt-1 text-[9px] font-extrabold uppercase tracking-[0.08em] text-[#667085] sm:text-[11px] sm:tracking-[0.14em]">
                    {label}
                  </p>
                </div>
              ))}
            ...
            {page.reasons.map((reason, index) => (
              ...
              >
                <span
                  ...
                  style={{
                    background: `linear-gradient(90deg, ${accent}, #6f63ff)`,
                  }}
                />
                <span
                  className="pointer-events-none absolute -right-10 -top-10 h-28 w-28 rounded-full blur-2xl transition"
                  style={{ backgroundColor: `${accent}1a` }}
                />
                <div className="relative z-10 flex items-start gap-4">
                  <div
                    className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-[#ffe0e4] bg-[linear-gradient(145deg,#ffffff,#fff3f5)] shadow-[0_12px_28px_rgba(255,63,81,0.12)] transition group-hover:scale-105"
                    style={{ color: accent }}
                  >
                  ...
                  <div className="min-w-0">
                    <h3
                      className="text-base font-extrabold leading-tight text-[#071124]"
                      style={textFill}
                    >
                      {reason.title}
                    </h3>
      ...
      {page.impactSection && (
        <section
          ...
          style={{
            backgroundImage: `url(${page.backgrounds.impact || page.backgrounds.process})`,
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
          ...
          <div className="container relative z-10 mx-auto grid max-w-full gap-8 px-4 sm:gap-10 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div className="min-w-0">
              ...
              <h2
                className="mt-5 !text-[clamp(1.8rem,9vw,2.5rem)] font-extrabold !leading-tight text-white sm:!text-5xl"
                style={textFill}
              >
                {page.impactSection.title}{" "}
                <span style={{ color: accent }}>
                  {page.impactSection.highlight}
                </span>
              </h2>
              ...
              <div className="mt-8 grid max-w-xl grid-cols-2 gap-3 sm:mt-9 sm:grid-cols-4 sm:gap-4">
                {page.impactSection.stats.map(([value, label, Icon]) => (
                  <div
                    key={label}
                    className="min-w-0 rounded-lg border border-white/12 bg-white/[0.045] p-4"
                  >
                    {Icon && (
                      <Icon
                        className="mb-4"
              ...
              {page.impactSection.cases.map((item) => (
                ...
                >
                  ...
                  <span className="block p-5">
                    ...
                    <span className="mt-3 block text-sm font-medium leading-6 text-white/70">
                      {item.text}
                    </span>
                    <span
                      className="mt-5 inline-flex items-center gap-2 text-sm font-extrabold"
      ...
      {testimonials.length > 0 && (
        <section
          ...
          style={{
            backgroundImage: `url(${page.backgrounds.testimonials})`,
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
          <div className="container relative z-10 mx-auto max-w-full px-4 sm:px-6">
            <div className="mb-10 text-center">
              <SectionBadge light>
                {page.testimonialsSection.badge}
              </SectionBadge>
              <h2
                className="mt-4 !text-[clamp(1.8rem,9vw,2.5rem)] font-extrabold !leading-tight text-white sm:!text-5xl"
                style={textFill}
              >
                {page.testimonialsSection.title}{" "}
                <span style={{ color: accent }}>
                  {page.testimonialsSection.highlight}
                </span>{" "}
                {page.testimonialsSection.suffix}
              </h2>
            </div>
          </div>
            ...
            <div className="testimonial-marquee-track">
              {loopTestimonials.map((item, index) => (
                ...
                >
                  ...
                  <blockquote className="flex-1 text-sm font-medium leading-7 text-white/82">
                    {item.body}
                  </blockquote>
      ...
      <section className="relative overflow-hidden border-y border-white/10 bg-[#06111f] py-12 text-white sm:py-16">
        <picture>
          {page.backgrounds.ctaMobile && (
            <source
              media="(max-width: 640px)"
              srcSet={page.backgrounds.ctaMobile}
            />
          )}
          <img
          ...
          <div
            className={
              ctaAlign === "center"
                ...
                : ctaAlign === "mobileCenter"
                  ? "flex min-w-0 flex-col items-center lg:items-start"
                  : "min-w-0"
            }
          >
            <h2
            ...
            >
              {page.cta.title}{" "}
              <span style={{ color: accent }}>{page.cta.highlight}</span>
            </h2>
            <p
              className={`mt-4 max-w-lg text-sm font-semibold leading-7 ${ctaTextTone === "dark" ? "text-[#263447]" : "text-white/72"}`}
            >
              {page.cta.description}
            </p>
          </div>
          <div
            className={`flex w-full min-w-0 flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:gap-4 ${ctaAlign === "center" || ctaAlign === "mobileCenter" ? "justify-center" : ""}`}
          >
            <button
